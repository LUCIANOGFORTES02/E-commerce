...
export default function Login() {
    ...
    const handleLogin= async() =>{
       ...
       if(isLogged){
              ...
              navigate('/private');//Para onde vai depois de logado 
       }
       else{
  ...
  return (
    <div className="h-full flex justify-center items-center">
       <div className="bg-background w-[21.875rem] p-[2.1875rem] flex-col ">
              <div className="text-lg font-semibold text-ring mt-[0.625rem] mb-[0.9375rem]" >
              ...
              <div className="w-full">
                     {showSignup &&(
                     <input className="border border-border text-black w-full mb-3 px-3 py-2 " 
